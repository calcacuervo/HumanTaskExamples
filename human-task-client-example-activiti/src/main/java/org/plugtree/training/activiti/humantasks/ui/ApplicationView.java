...
public class ApplicationView extends FrameView {
    ...
    private void initComponents() {
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(Application.class).getContext().getActionMap(ApplicationView.class, this);
        ...
        org.jdesktop.application.ResourceMap resourceMap = Application.getInstance(Application.class).getContext().getResourceMap(ApplicationView.class);
    ...
    public void startWorkAction() {
        ...
        refreshUserAssignedTasks(userKey);
    }
    ...
    private void refreshUserAssignedTasks(String userName) {
        List<Task> taskSummarys = null;
        try {
            taskSummarys = client.getAssignedTasks(userName);
        }
        catch (Exception ex) {
        ...
        for (Task taskSummary : taskSummarys) {
